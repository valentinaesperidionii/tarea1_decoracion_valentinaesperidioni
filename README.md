...
Sitio web de inspiración para decorar el hogar, con tres categorías de productos: velas, sets y difusores.
...
- **Marrones oscuros (rgb(74, 49, 10) / rgb(88, 61, 22) / rgb(12, 8, 3))**: usados para el texto sobre los fondos claros, en distintas variaciones según la sección (header, footer, párrafos), para mantener buen contraste sin usar negro puro.
- **Blanco (rgb(255, 255, 255))**: usado en el texto de los botones, para que resalte sobre el fondo marrón oscuro.

## Tipografía utilizada
Se utilizó **Arial, Helvetica, sans-serif** como familia tipográfica para todo el sitio. Al ser una fuente sans-serif estándar, ofrece buena legibilidad en cualquier dispositivo y navegador, sin distraer del contenido visual (fotos de los productos).
